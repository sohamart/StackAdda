...
const Login = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-4 py-28 sm:px-6 lg:py-32">
      ...
      {/* Background Glow */}
      <div className="absolute  left-0 top-0 w-96 h-96 lg:bg-orange-500/20 bg-orange-500/5 blur-3xl" />
      <div className="absolute right-0 bottom-0 w-96 h-96 lg:bg-orange-500/20 bg-orange-500/5 blur-3xl" />

      <div className="relative z-10 w-full max-w-5xl overflow-hidden rounded-2xl border border-orange-500/20 bg-white/[0.04] backdrop-blur-md sm:rounded-3xl">
